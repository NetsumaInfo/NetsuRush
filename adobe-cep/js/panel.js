...
(function () {
  ...
  var TEXT = {
    fr: {
      ...
      errNoProject:"aucun projet ouvert",errMissingSource:"chemin source manquant",errImportFailed:"import échoué",errMediaMissing:"fichier introuvable sur le disque",errClipNotFound:"clip introuvable ou import échoué",errSequenceCreateFailed:"création de séquence échouée",errInsertFailed:"insertion échouée",errNoShotsInserted:"aucun plan inséré",errNoValidShots:"aucun plan valide",errNoLayersAdded:"aucun calque posé",errScriptMissing:"script introuvable",errScriptFailed:"échec du script hôte",errUnsupportedOp:"opération non supportée par cet hôte",errMissingPath:"chemin de sortie manquant",errNoSequence:"aucune séquence ouverte",errExportEmpty:"aucun fichier écrit",errTrackCreateFailed:"impossible de créer une piste vidéo au-dessus",errNoClipAtPlayhead:"aucun plan à remplacer sous la tête de lecture",errNoLayerAtPlayhead:"aucun calque à remplacer sous la tête de lecture",errRemoveFailed:"le plan remplacé n’a pas pu être supprimé",errVideoOnlyFailed:"impossible de préparer une insertion vidéo seule",errImportRefused:"import refusé par Premiere",errImportNoSequence:"l’import n’a créé aucune séquence",errImportEmptySequence:"la séquence importée est vide",errHostStale:"scripts hôtes périmés : redémarre l’application Adobe",errQeUnavailable:"non disponible dans cette version de Premiere",errQeCallFailed:"Premiere a refusé l’opération",errUnsupportedVersion:"non disponible dans cette version de l’application",errNoProxyPairs:"aucun proxy à attacher",errPurgeFailed:"After Effects a refusé la purge",errorWithDetail:"{message} : {detail}",quotedTimeline:"« {name} » · ",subclipVideo:"{name} — vidéo {part}",subclipWhole:"entière",untitledProject:"Sans titre",hygieneUndo:"NetsuRush — nettoyage du projet"
    },
    en: {
      ...
      errNoProject:"no project open",errMissingSource:"source path missing",errImportFailed:"import failed",errMediaMissing:"file not found on disk",errClipNotFound:"clip not found or import failed",errSequenceCreateFailed:"sequence creation failed",errInsertFailed:"insert failed",errNoShotsInserted:"no shots inserted",errNoValidShots:"no valid shots",errNoLayersAdded:"no layers added",errScriptMissing:"script not found",errScriptFailed:"host script failed",errUnsupportedOp:"operation not supported by this host",errMissingPath:"output path missing",errNoSequence:"no sequence open",errExportEmpty:"no file was written",errTrackCreateFailed:"could not create a video track above",errNoClipAtPlayhead:"no clip to replace under the playhead",errNoLayerAtPlayhead:"no layer to replace under the playhead",errRemoveFailed:"the replaced clip could not be removed",errVideoOnlyFailed:"could not prepare a video-only insert",errImportRefused:"import refused by Premiere",errImportNoSequence:"the import created no sequence",errImportEmptySequence:"the imported sequence is empty",errHostStale:"stale host scripts: restart the Adobe application",errQeUnavailable:"not available in this version of Premiere",errQeCallFailed:"Premiere refused the operation",errUnsupportedVersion:"not available in this version of the application",errNoProxyPairs:"no proxies to attach",errPurgeFailed:"After Effects refused the purge",errorWithDetail:"{message}: {detail}",quotedTimeline:"“{name}” · ",subclipVideo:"{name} — video {part}",subclipWhole:"whole",untitledProject:"Untitled",hygieneUndo:"NetsuRush — project cleanup"
    },
    es: {
      ...
      errNoProject:"no hay ningún proyecto abierto",errMissingSource:"falta la ruta de origen",errImportFailed:"falló la importación",errMediaMissing:"no se encuentra el archivo en el disco",errClipNotFound:"no se encontró el clip o falló la importación",errSequenceCreateFailed:"no se pudo crear la secuencia",errInsertFailed:"falló la inserción",errNoShotsInserted:"no se insertó ningún plano",errNoValidShots:"no hay ningún plano válido",errNoLayersAdded:"no se añadió ninguna capa",errScriptMissing:"no se encontró el script",errScriptFailed:"falló el script del host",errUnsupportedOp:"operación no admitida por este host",errMissingPath:"falta la ruta de salida",errNoSequence:"no hay ninguna secuencia abierta",errExportEmpty:"no se escribió ningún archivo",errTrackCreateFailed:"no se pudo crear una pista de vídeo encima",errNoClipAtPlayhead:"no hay ningún clip que reemplazar bajo el cabezal",errNoLayerAtPlayhead:"no hay ninguna capa que reemplazar bajo el cabezal",errRemoveFailed:"no se pudo quitar el clip reemplazado",errVideoOnlyFailed:"no se pudo preparar una inserción solo de vídeo",errImportRefused:"Premiere rechazó la importación",errImportNoSequence:"la importación no creó ninguna secuencia",errImportEmptySequence:"la secuencia importada está vacía",errHostStale:"scripts del host obsoletos: reinicia la aplicación de Adobe",errQeUnavailable:"no disponible en esta versión de Premiere",errQeCallFailed:"Premiere rechazó la operación",errUnsupportedVersion:"no disponible en esta versión de la aplicación",errNoProxyPairs:"no hay proxies que vincular",errPurgeFailed:"After Effects rechazó la purga",errorWithDetail:"{message}: {detail}",quotedTimeline:"«{name}» · ",subclipVideo:"{name} — vídeo {part}",subclipWhole:"completo",untitledProject:"Sin título",hygieneUndo:"NetsuRush — limpieza del proyecto"
    },
    de: {
      ...
      errNoProject:"kein Projekt geöffnet",errMissingSource:"Quellpfad fehlt",errImportFailed:"Import fehlgeschlagen",errMediaMissing:"Datei auf dem Datenträger nicht gefunden",errClipNotFound:"Clip nicht gefunden oder Import fehlgeschlagen",errSequenceCreateFailed:"Sequenz konnte nicht erstellt werden",errInsertFailed:"Einfügen fehlgeschlagen",errNoShotsInserted:"keine Clips eingefügt",errNoValidShots:"keine gültigen Clips",errNoLayersAdded:"keine Ebenen eingefügt",errScriptMissing:"Skript nicht gefunden",errScriptFailed:"Host-Skript fehlgeschlagen",errUnsupportedOp:"Von diesem Host nicht unterstützte Operation",errMissingPath:"Ausgabepfad fehlt",errNoSequence:"keine Sequenz geöffnet",errExportEmpty:"keine Datei geschrieben",errTrackCreateFailed:"Videospur darüber konnte nicht erstellt werden",errNoClipAtPlayhead:"kein Clip zum Ersetzen unter dem Abspielkopf",errNoLayerAtPlayhead:"keine Ebene zum Ersetzen unter der Zeitmarke",errRemoveFailed:"ersetzter Clip konnte nicht entfernt werden",errVideoOnlyFailed:"reines Video-Einfügen konnte nicht vorbereitet werden",errImportRefused:"Import von Premiere abgelehnt",errImportNoSequence:"Import hat keine Sequenz erstellt",errImportEmptySequence:"importierte Sequenz ist leer",errHostStale:"veraltete Host-Skripte: starte die Adobe-App neu",errQeUnavailable:"in dieser Premiere-Version nicht verfügbar",errQeCallFailed:"Premiere hat den Vorgang abgelehnt",errUnsupportedVersion:"in dieser App-Version nicht verfügbar",errNoProxyPairs:"keine Proxys zum Anhängen",errPurgeFailed:"After Effects hat das Leeren abgelehnt",errorWithDetail:"{message}: {detail}",quotedTimeline:"„{name}“ · ",subclipVideo:"{name} – Video {part}",subclipWhole:"komplett",untitledProject:"Ohne Titel",hygieneUndo:"NetsuRush – Projektbereinigung"
    },
    ja: {
      ...
      errNoProject:"プロジェクトが開かれていません",errMissingSource:"ソースパスがありません",errImportFailed:"読み込みに失敗しました",errMediaMissing:"ディスク上にファイルが見つかりません",errClipNotFound:"クリップが見つからないか、読み込みに失敗しました",errSequenceCreateFailed:"シーケンスを作成できませんでした",errInsertFailed:"挿入に失敗しました",errNoShotsInserted:"ショットを挿入できませんでした",errNoValidShots:"有効なショットがありません",errNoLayersAdded:"レイヤーを配置できませんでした",errScriptMissing:"スクリプトが見つかりません",errScriptFailed:"ホストスクリプトが失敗しました",errUnsupportedOp:"このホストでは対応していない操作です",errMissingPath:"出力パスがありません",errNoSequence:"シーケンスが開かれていません",errExportEmpty:"ファイルが書き出されませんでした",errTrackCreateFailed:"上にビデオトラックを作成できませんでした",errNoClipAtPlayhead:"再生ヘッドの下に置き換えるクリップがありません",errNoLayerAtPlayhead:"再生ヘッドの下に置き換えるレイヤーがありません",errRemoveFailed:"置き換えたクリップを削除できませんでした",errVideoOnlyFailed:"ビデオのみの挿入を準備できませんでした",errImportRefused:"Premiere が読み込みを拒否しました",errImportNoSequence:"読み込みでシーケンスが作成されませんでした",errImportEmptySequence:"読み込んだシーケンスが空です",errHostStale:"ホストスクリプトが古いままです。Adobe アプリを再起動してください",errQeUnavailable:"この Premiere のバージョンでは利用できません",errQeCallFailed:"Premiere が操作を拒否しました",errUnsupportedVersion:"このバージョンのアプリでは利用できません",errNoProxyPairs:"アタッチするプロキシがありません",errPurgeFailed:"After Effects がキャッシュの削除を拒否しました",errorWithDetail:"{message}：{detail}",quotedTimeline:"「{name}」 · ",subclipVideo:"{name} — ビデオ {part}",subclipWhole:"全体",untitledProject:"無題",hygieneUndo:"NetsuRush — プロジェクトの整理"
    },
    zh: {
      ...
      errNoProject:"没有打开的项目",errMissingSource:"缺少源路径",errImportFailed:"导入失败",errMediaMissing:"磁盘上找不到该文件",errClipNotFound:"找不到剪辑或导入失败",errSequenceCreateFailed:"无法创建序列",errInsertFailed:"插入失败",errNoShotsInserted:"未插入任何镜头",errNoValidShots:"没有有效镜头",errNoLayersAdded:"未添加任何图层",errScriptMissing:"找不到脚本",errScriptFailed:"宿主脚本执行失败",errUnsupportedOp:"该宿主不支持此操作",errMissingPath:"缺少输出路径",errNoSequence:"没有打开的序列",errExportEmpty:"未写入任何文件",errTrackCreateFailed:"无法在上方创建视频轨道",errNoClipAtPlayhead:"播放头下没有可替换的剪辑",errNoLayerAtPlayhead:"播放头下没有可替换的图层",errRemoveFailed:"无法移除被替换的剪辑",errVideoOnlyFailed:"无法准备仅视频插入",errImportRefused:"Premiere 拒绝了导入",errImportNoSequence:"导入未创建任何序列",errImportEmptySequence:"导入的序列为空",errHostStale:"宿主脚本已过期：请重启 Adobe 应用",errQeUnavailable:"此版本的 Premiere 不支持该功能",errQeCallFailed:"Premiere 拒绝了该操作",errUnsupportedVersion:"此版本的应用不支持",errNoProxyPairs:"没有可附加的代理文件",errPurgeFailed:"After Effects 拒绝了清理",errorWithDetail:"{message}：{detail}",quotedTimeline:"“{name}” · ",subclipVideo:"{name} — 视频 {part}",subclipWhole:"完整",untitledProject:"无标题",hygieneUndo:"NetsuRush — 项目清理"
    }
  };
  var HOST_ERROR_KEYS = {
    ...
    MISSING_PATH:"errMissingPath",NO_SEQUENCE:"errNoSequence",EXPORT_EMPTY:"errExportEmpty",
    TRACK_CREATE_FAILED:"errTrackCreateFailed",NO_CLIP_AT_PLAYHEAD:"errNoClipAtPlayhead",
    NO_LAYER_AT_PLAYHEAD:"errNoLayerAtPlayhead",REMOVE_FAILED:"errRemoveFailed",
    VIDEO_ONLY_SUBCLIP_FAILED:"errVideoOnlyFailed",IMPORT_REFUSED:"errImportRefused",
    IMPORT_NO_SEQUENCE:"errImportNoSequence",IMPORT_EMPTY_SEQUENCE:"errImportEmptySequence",
  ...
  // Host scripts answer with an `errorCode` (boost operations name it `code`) and English developer
  // text. The user reads the text of the code, in the interface language, plus the detail the
  // host attached (a path, the host's own exception). Unknown codes keep the host's text.
  function hostResultError(result) {
    var key = result && HOST_ERROR_KEYS[result.errorCode || result.code];
    if (!key) return (result && result.error) || tr("failed");
    return result.errorDetail ? trf("errorWithDetail", { message: tr(key), detail: result.errorDetail }) : tr(key);
  }
  // Names the host scripts write into the user's project, in the interface language.
  function hostText() {
    return {
      videoSubclip: tr("subclipVideo"), wholeClip: tr("subclipWhole"),
      untitledProject: tr("untitledProject"), hygieneUndo: tr("hygieneUndo")
    };
  }
  // A JS literal for the code handed to evalScript. Non-ASCII goes as \u escapes, which ES3 reads
  // whatever encoding the host assumes for the evaluated string.
  ...
  function scanNow() {
    ...
    cs.evalScript("NR_getSnapshot(" + hostLiteral(hostText()) + ")", function (res) {
  ...
  function jobNow(p, fn, label, retried) {
    ...
    payload.nrText = hostText();
    var code = fn + "(" + hostLiteral(payload) + ")";
    cs.evalScript(code, function (res) {
      ...
      // The core shows `error` as is: it leaves here in the interface language, the code kept beside it.
      if (result && !result.ok && (result.errorCode || result.code)) result.error = hostResultError(result);
      rpc("adobe:jobResult", [{ jobId: p.jobId, result: result }]).catch(function () {});
      var count = result.count || 0;
      var translatedLabel = tr(label);
      log(result.ok
        ? trf("jobSuccess", { label: translatedLabel, timeline: result.timeline ? trf("quotedTimeline", { name: result.timeline }) : "", count: count, items: tr(count === 1 ? "item" : "items") })
